    ...
    return (
        <section className="footerSection">
                ...
                <div className="footer container">
                    <div className="footerContent grid ">
                        <div className="footerContent_left ">
                            ...
                            <div className="footerContent_left_content flex">
                                <div className="footerContent_left_content_left">
                                    <p>
                                        Cái tên Degrey được tạo ra rất ngẫu hứng, xuất phát từ “Chuỗi ngày u buồn về sự
                                        nghiệp, tương lai trong quá khứ của chính mình” – theo lời chia sẻ của Degrey’s
                                        founder.
                                    </p>
                                    <img src={img} alt="" />
                                </div>
                        ...
                        <div className="footerContent_right flex ">
                            ...
                            <div className="footerContent_three ">
            ...
            <div className="footerFooter container flex">
                <p>
                    Copyright © 2022
                    <a href="https://degrey.vn/?fbclid=IwAR1DMRsHT1TyEnlxmqd0_N6Aoku2PbU-XlIWRIVOXPQcLWOztWdirePz9Bs">
                        DEGREY VIETNAM.
                    </a>
                    <a href="/">MVD</a>
                </p>
